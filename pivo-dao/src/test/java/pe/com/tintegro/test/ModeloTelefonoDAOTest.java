...
public class ModeloTelefonoDAOTest
{
	@Autowired
	ModeloTelefonoDAO modeloTelefonoDAO;
	...
	public void testModeloTelefonoPorMarcaList()
	{
		try
		{
			...
			ListaModeloTelefonoPorMarcaResponse response = modeloTelefonoDAO
					.listaModeloTelefonoPorMarca("192.168.3.206", request);
