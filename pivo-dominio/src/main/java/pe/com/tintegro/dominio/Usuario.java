...
public class Usuario implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8756272006717593865L;
	...
	public String toString() {
		return "Usuario [idUsuario=" + idUsuario + ", noLogin=" + noLogin + ", noPasswo=" + noPasswo + ", noNombre="
				+ noNombre + ", noApellido=" + noApellido + ", email=" + email + ", noProfe=" + noProfe + ", ilActivo="
				+ ilActivo + ", feCreacion=" + feCreacion + ", ilAccountNonWExpired=" + ilAccountNonWExpired
				+ ", ilCredentialNonExpired=" + ilCredentialNonExpired + ", ilAccountNonLocked=" + ilAccountNonLocked
				+ ", noRol=" + noRol + ", idRol=" + idRol + ", idInstancia=" + idInstancia + ", idInstanciaEncryp="
				+ idInstanciaEncryp + ", noInstancia=" + noInstancia + ", idCliente=" + idCliente + ", noCliente="
				+ noCliente + ", idTipoRol=" + idTipoRol + ", noNewPassword=" + noNewPassword + ", noToken=" + noToken
				+ ", result=" + result + ", mensaje=" + mensaje + ", nuDocumento=" + nuDocumento + "]";
	}
