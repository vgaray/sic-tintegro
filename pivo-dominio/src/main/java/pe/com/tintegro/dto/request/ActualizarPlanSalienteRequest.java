...
public class ActualizarPlanSalienteRequest extends RequestBase
{
	...
	public Integer getHoTemporizado()
	{
		return hoTemporizado;
	}
	public void setHoTemporizado(Integer hoTemporizado)
	{
